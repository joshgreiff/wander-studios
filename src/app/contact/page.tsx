  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-orange-200 via-orange-400 to-red-400 flex flex-col items-center p-4">
      <section className="max-w-2xl w-full bg-white/80 rounded-xl shadow-lg p-8 mt-8">
        ...
        <p className="mb-4 text-orange-800">Have questions or want to connect? Reach out below.</p>
        <div className="mb-8">
          ...
          <p className="text-orange-800">Or email us directly: <a href="mailto:ltwander@gmail.com" className="underline text-orange-700">ltwander@gmail.com</a></p>
        </div>
